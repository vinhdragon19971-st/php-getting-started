        ...
        <div class="panel"><!-- panel begin -->
            <div class="panel-body"><!-- panel-body begin -->
                <div class="mb-md thumb-info"><!-- mb-md thumb-info begin -->
                    ...
                    <img src="admin_images/admin.jpg" alt="admin-thumb-info" class="rounded img-responsive">
                    
                    <div class="thumb-info-title"><!-- thumb-info-title begin -->
                       
                        <span class="thumb-info-inner"> Admin </span>
                        <span class="thumb-info-type"> ATN Developer </span>
                ...
                <div class="mb-md"><!-- mb-md begin -->
                    <div class="widget-content-expanded"><!-- widget-content-expanded begin -->
                        <i class="fa fa-user"></i> <span> Email: </span> yeuthichcongviec1097@gmail.com <br/>
                        <i class="fa fa-flag"></i> <span> Country: </span> Vietnam <br/>
                        <i class="fa fa-envelope"></i> <span> Contact: </span> 0123-4567-8910 <br/>
                    ...
                    <p><!-- p begin -->
                        ...
                        This application is created by ATN Developer, if you willing to contact me, please click this link. <br/>
                        <a href="#"> ATN Developer </a> <br/>
